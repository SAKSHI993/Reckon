...
function echoaddadslog($s){
	...
	<a   class='btn btn-lg btn-block addads ' href='createads.php'>+ Donate for a cause</a></div>";
	}else {
	echo "</header>";
	}
}
...
function echoaddadsnolog(){
	echo "</header>
	<div class='container control'>
	<a   class='btn btn-lg btn-block addads ' href='' data-toggle='modal' data-target='#myModal'>+ Donate for a cause</a>
	</div>
	";
}
